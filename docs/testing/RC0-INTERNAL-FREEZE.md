...
| Protocol-freeze candidate | The protocol inventory has 34 records: 0 Stable, 16 Experimental, 14 Preview, 1 Internal, and 3 Future. | BlockedSpec | Accepted versions, reader/unknown-field/migration rules, golden and corrupt-input fixtures, and an inventory revision tied to the candidate. |
