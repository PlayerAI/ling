...
| Protocol-freeze candidate | The protocol inventory has 50 records: 0 Stable, 16 Experimental, 29 Preview, 1 Internal, and 4 Future. | BlockedSpec | Accepted versions, reader/unknown-field/migration rules, golden and corrupt-input fixtures, and an inventory revision tied to the candidate. |
