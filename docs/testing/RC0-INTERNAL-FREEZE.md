...
| Protocol-freeze candidate | The protocol inventory has 40 records: 0 Stable, 16 Experimental, 20 Preview, 1 Internal, and 3 Future. | BlockedSpec | Accepted versions, reader/unknown-field/migration rules, golden and corrupt-input fixtures, and an inventory revision tied to the candidate. |
