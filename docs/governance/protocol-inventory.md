...
| `PROTO-BYTECODE` | Public | Bytecode | `ling.bytecode/1.2` | `Experimental` | no | no | 6 |
...
- Consumer: VM-1203 bounded independent decoder/verifier; VM-1204 verifier-gated ling-vm executor; VM-1205 closure/partial-application VM execution; VM-1206 aggregate/match VM execution; VM-1208 explicit host-capability preflight and Runtime Fault boundary
