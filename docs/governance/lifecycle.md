...
| `RFC-0025` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0025](../RFC-0025.md) |
| `RFC-0026` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0026](../RFC-0026.md) |
| `RFC-0027` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0027](../RFC-0027.md) |
| `RFC-0028` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0028](../RFC-0028.md) |
| `RFC-0029` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0029](../RFC-0029.md) |
| `RFC-0030` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0030](../RFC-0030.md) |
| `RFC-0031` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0031](../RFC-0031.md) |
| `RFC-0032` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0032](../RFC-0032.md) |
| `RFC-0033` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0033](../RFC-0033.md) |
| `RFC-0034` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0034](../RFC-0034.md) |
| `RFC-0035` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0035](../RFC-0035.md) |
| `RFC-0036` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0036](../RFC-0036.md) |
| `RFC-0037` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0037](../RFC-0037.md) |
| `RFC-0038` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0038](../RFC-0038.md) |
| `RFC-0039` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0039](../RFC-0039.md) |
| `RFC-0040` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [RFC-0040](../RFC-0040.md) |
...
| `RFC-0045` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0045](../RFC-0045.md) |
| `RFC-0046` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0046](../RFC-0046.md) |
| `RFC-0047` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0047](../RFC-0047.md) |
| `RFC-0048` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0048](../RFC-0048.md) |
| `RFC-0049` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0049](../RFC-0049.md) |
| `RFC-0050` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0050](../RFC-0050.md) |
| `RFC-0051` | RFC | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-24` | [RFC-0051](../RFC-0051.md) |
...
| `DEC-0196` | Decision | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [DEC-0196](../decisions/0196-solver-proof-checker-boundary-evidence.md) |
...
| `DEC-0203` | Decision | `Accepted` | `Open` → `Draft` → `Proposed` → `Accepted` | yes | no | `2026-08-23` | [DEC-0203](../decisions/0203-exploration-engine-boundary-evidence.md) |
...
| `DEC-0278` | Decision | `Proposed` | `Open` → `Draft` → `Proposed` | no | no | — | [DEC-0278](../decisions/0278-private-supervision-executable-evidence-matrix.md) |
