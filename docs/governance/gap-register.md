...
| --- | --- | --- | --- | --- |
| `G1-BYTECODE` — Bytecode version, verifier, evaluation, Fault, and compatibility | `v0.1` | `ROADMAP-1.0` | `GAP-BYTECODE-SEMANTICS-001` | `RFC-0014` |
...
| `GAP-BYTECODE-SEMANTICS-001` | `P0` | `Accepted` | Versioned bytecode and verifier observable semantics | `VM-1201`, `VM-1202`, `VM-1203`, `VM-1204`, `VM-1208`, `VM-1209`, `VM-1210` | `RFC-0014` |
