...
| `UNSUP-VM` | Execution | Bytecode emission, verification, or VM execution | VM-1201 provides an explicitly unverified ling.bytecode/1.0 data model and reference corpus only; no encoder, decoder, verifier, executable VerifiedProgram boundary, or VM exists yet. | — | [`docs/RFC-0014.md`](../RFC-0014.md)<br>[`crates/ling-bytecode/src/lib.rs`](../../crates/ling-bytecode/src/lib.rs)<br>[`tests/bytecode/README.md`](../../tests/bytecode/README.md)<br>[`docs/ling_execution_plan/03-G1-V0.1-LIVING.md`](../ling_execution_plan/03-G1-V0.1-LIVING.md) |
