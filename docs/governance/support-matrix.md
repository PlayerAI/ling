...
| `PROTO-ACTOR-SEMANTIC-GRAPH-EXTENSION` | `Public` | `x-ling-actor/0.1` | `Experimental` | yes |
...
| `PROTO-LSP-CODE-ACTION` | `Public` | `ling.lsp.code-action/0.1` | `Preview` | yes |
| `PROTO-LSP-COMPLETION` | `Public` | `ling.lsp.completion/0.2` | `Preview` | yes |
