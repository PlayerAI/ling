...
| `UNSUP-PACKAGES` | Project/package | CLI project selection, dependency-package graph loading and visibility, lockfile, package installation, or registry | PRJ-1101/1102 implement the isolated ling.toml version 1 reader and explicit-root deterministic source/module discovery, but PRJ-1103 through PRJ-1105 have not implemented cross-package visibility, recursive local dependency resolution, content identity, or the lock reader/writer; CLI integration and registry installation remain out of scope. | — | [`docs/RFC-0002.md`](../RFC-0002.md)<br>[`docs/ling_execution_plan/03-G1-V0.1-LIVING.md`](../ling_execution_plan/03-G1-V0.1-LIVING.md) |
