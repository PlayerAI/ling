...
| `UNSUP-PACKAGES` | Project/package | Project discovery and graph loading, lockfile, dependency resolver, package installation, or registry | PRJ-1101 implements the isolated ling.toml version 1 reader, but PRJ-1102 through PRJ-1105 have not implemented filesystem discovery, module/package graphs, visibility, local resolution, content identity, or the lock reader/writer; registry installation remains out of scope. | — | [`docs/RFC-0002.md`](../RFC-0002.md)<br>[`docs/ling_execution_plan/03-G1-V0.1-LIVING.md`](../ling_execution_plan/03-G1-V0.1-LIVING.md) |
