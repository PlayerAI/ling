...
| `UNSUP-PACKAGES` | Project/package | CLI project selection, package installation, publication, or registry | PRJ-1101 through PRJ-1105 implement the isolated manifest, deterministic package graph, exported-module visibility, checked cross-package resolution, package-aware Semantic Graph, and canonical local lock protocol. CLI selection/build integration, publication, and registry installation remain out of scope. | — | [`docs/RFC-0002.md`](../RFC-0002.md)<br>[`docs/ling_execution_plan/03-G1-V0.1-LIVING.md`](../ling_execution_plan/03-G1-V0.1-LIVING.md) |
