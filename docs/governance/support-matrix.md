...
| `UNSUP-LSP-EDITOR` | Tooling | LSP, Tree-sitter grammar, Zed extension, formatter, or semantic mutation | No corresponding executable, editor package, or accepted transaction boundary exists. | `GAP-LSP-TRANSACTION-PROTOCOL-001`<br>`GAP-FORMATTER-AUTHOR-SOURCE-001`<br>`GAP-SEMANTIC-PROTOCOL-LIFECYCLE-001` | [`docs/governance/gap-register.toml`](../governance/gap-register.toml) |
...
| `UNSUP-PACKAGES` | Project/package | Project manifest, lockfile, dependency resolver, package installation, or registry | Package identity and protocol semantics are unresolved. | `GAP-PACKAGE-NAMESPACE-001`<br>`GAP-PACKAGE-PROTOCOL-001` | [`docs/governance/gap-register.toml`](../governance/gap-register.toml) |
