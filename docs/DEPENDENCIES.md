...
| `num-bigint` | 0.5.1 | Mathematical `Int` parsing, typed literals, canonical semantic bytes, interpreter arithmetic, and canonical bytecode sign/magnitude lowering | MIT OR Apache-2.0 | 1.60 | Yes, validated UTF-8 construction, division internals, and target intrinsics | Current crates.io release inspected 2026-08-18; default `std` feature only; bytecode reuses the locked workspace package |
