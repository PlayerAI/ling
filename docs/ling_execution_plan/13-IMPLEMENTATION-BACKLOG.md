...
| `REP-2501` | G2 | Determinism Class | L | Ready | Accepted `DEC-0279` authorizes only the private five-category executable baseline; public class metadata, Effect Log, and Replay remain blocked; see `docs/status/REP-2501-AUTHORITY-AUDIT.md` |
