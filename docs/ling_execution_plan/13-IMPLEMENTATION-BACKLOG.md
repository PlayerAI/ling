...
| `ACT-2306` | G2 | Actor 性质与压力测试 | L | BlockedSpec | ACT-2305 is Done; proposed `DEC-0275` defines the missing local property/stress and parallel-turn evidence contract, but grants no implementation authority until Accepted; see `docs/status/ACT-2306-AUTHORITY-AUDIT.md` |
