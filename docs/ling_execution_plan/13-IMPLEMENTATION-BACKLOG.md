...
| `TASK-2203` | G2 | 结构化生命周期 Runtime | L | BlockedSpec | Proposed `DEC-0266` defines the scheduler-neutral lifecycle kernel and same-scope linear handle registry; implementation awaits acceptance; see `docs/status/TASK-2203-AUTHORITY-AUDIT.md` |
