...
G1：`TS-3101`、`TS-3102`、`TS-3103`、`TS-3104` Done；`DEC-0017` 已解除布尔运算符规范阻断，下一项 `TS-3105` In Progress，其余任务仍服从各自接口与 RFC 前置
...
| `TS-3105` | G1/Editor | Expression precedence | M | In Progress | `05-ZED-EXTENSION.md:211`；Accepted `DEC-0017`；实现 compiler/Tree-sitter precedence 与 short-circuit differential evidence |
