...
| `REP-2502` | G2 | Replay Log Schema | L | BlockedSpec | REP-2501 is Done; Proposed `DEC-0280` defines a private non-serialized five-case structure-evidence baseline but is not implementation authority until Accepted; public Effect Log and Replay schema remain blocked; see `docs/status/REP-2502-AUTHORITY-AUDIT.md` |
