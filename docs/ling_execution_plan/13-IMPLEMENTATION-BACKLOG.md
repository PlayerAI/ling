...
| `DOC-6703-SEED` | G6 | Seed bilingual tutorial coverage drift gate | S | In Progress | Accepted DEC-0047; see `cargo xtask tutorial verify`, `docs/testing/TUTORIAL-COVERAGE.md`, and `docs/status/DOC-6703-SEED-IMPLEMENTATION-REPORT.md`; parent remains BlockedSpec |
