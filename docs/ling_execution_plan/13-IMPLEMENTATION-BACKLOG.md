...
G1：`TS-3101`、`TS-3102`、`TS-3103`、`TS-3104`、`TS-3105` Done；下一项 `TS-3106` Ready，其余任务仍服从各自接口与 RFC 前置
...
| `TS-3106` | G1/Editor | Pattern 与 Type | M | Ready | `05-ZED-EXTENSION.md:217`；Seed 模式/类型权威与编译器行为已存在；依赖 `TS-3105` Done |
