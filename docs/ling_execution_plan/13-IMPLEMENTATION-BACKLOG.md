...
| `SUP-2403` | G2 | 监督测试 | L | Ready | Accepted `DEC-0278` authorizes a private checked-runtime evidence matrix over Accepted DEC-0274 through DEC-0277; state restore, escalation, public fixtures, Replay, and cross-backend claims remain deferred; see `docs/status/SUP-2403-AUTHORITY-AUDIT.md` |
