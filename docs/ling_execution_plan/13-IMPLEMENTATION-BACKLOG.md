...
| `ACT-2306` | G2 | Actor 性质与压力测试 | L | Ready | Accepted `DEC-0275` authorizes the bounded local property/stress and parallel-turn evidence contract; implementation remains internal Experimental Rust evidence and public Actor execution remains `L-ACTOR-0002`; see `docs/status/ACT-2306-AUTHORITY-AUDIT.md` |
