...
| `ZED-3504` | G1/Editor | Snippets | — | Blocked by G0/interface | `05-ZED-EXTENSION.md:512` |
  | `EFF-2101` | G2 | Effect 核心模型冻结 | M | In Progress | `06-G2-V0.2-CONCURRENT.md:81`, `docs/RFC-0006.md`, `docs/status/EFF-2101-AUTHORITY-AUDIT.md`, `docs/status/EFF-2101-IMPLEMENTATION-REPORT.md` |
