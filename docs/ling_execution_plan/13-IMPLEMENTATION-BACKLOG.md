...
| `TASK-2201` | G2 | Task 语法与 Checked Core | M | Done | Accepted `DEC-0264`; checked-only frontend/Core completed in `54e4cecb`; see `docs/status/TASK-2201-IMPLEMENTATION-REPORT.md`; runtime remains TASK-2202 through TASK-2206 |
...
| `TASK-2202` | G2 | Task 状态机 Lowering | L | BlockedSpec | Proposed `DEC-0265` defines a checked-only `ling.task-machine/0.1` candidate but is not implementation authority; see `docs/status/TASK-2202-AUTHORITY-AUDIT.md` |
