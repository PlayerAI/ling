...
| `TASK-2204` | G2 | 确定性测试调度器 | L | BlockedSpec | Proposed `DEC-0267` defines exact seed, virtual-time, trace/replay, and bounded-exploration behavior; implementation waits for Accepted authority; see `docs/status/TASK-2204-AUTHORITY-AUDIT.md` |
