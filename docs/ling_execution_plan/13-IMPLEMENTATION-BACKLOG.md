...
| `ACT-2304` | G2 | Turn 与重入规则 | L | BlockedSpec | `DEC-0273` Proposed checked-only non-suspending/no-reentry profile; explicit acceptance required before implementation; `docs/status/ACT-2304-AUTHORITY-AUDIT.md` |
