...
| `SUP-2402` | G2 | 重启预算与熔断 | L | BlockedSpec | SUP-2401 is Done; Proposed `DEC-0277` defines the candidate private logical-tick/budget/backoff/circuit slice but is not implementation authority until Accepted; see `docs/status/SUP-2402-AUTHORITY-AUDIT.md` |
