...
| `ACT-2301` | G2 | Actor 身份与状态隔离 | M | BlockedSpec | Proposed `DEC-0270`; implementation awaits explicit acceptance; `06-G2-V0.2-CONCURRENT.md:250`, `docs/status/ACT-2301-AUTHORITY-AUDIT.md` |
