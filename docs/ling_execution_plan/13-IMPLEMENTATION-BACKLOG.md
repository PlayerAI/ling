...
| `IDE-2309` | G1/Editor | Code actions | L | Done | Accepted `RFC-0044`; Public Preview `ling.lsp.code-action/0.1`; implementation commit `369432ef6146a27e236276ced2ab14e9065ca5af`; see `crates/ling-lsp/src/code_action.rs`, `crates/ling-lsp/tests/code_action.rs`, and `docs/status/IDE-2309-IMPLEMENTATION-REPORT.md` |
| `IDE-2309-REPAIR-INDEX` | G1/Editor | Internal structured diagnostic repair index | S | Done | Accepted `DEC-0081`; retained as opaque diagnostic metadata and not interpreted as edits by completed `IDE-2309`; see `crates/ling-diagnostics/src/repair_index.rs` and `docs/status/IDE-2309-REPAIR-INDEX-IMPLEMENTATION-REPORT.md` |
| `IDE-2310` | G1/Editor | Formatting | M | Done | Accepted `RFC-0026`; Experimental `ling.lsp.formatting/0.1`; implementation commits `0421925f3a8e20f6bc951eff546b00523c3f36ff` and `d8e2a377830d0e34f27603036253e649214bdcaf`; see `crates/ling-lsp/tests/formatting.rs` and `docs/status/IDE-2310-IMPLEMENTATION-REPORT.md` |
| `IDE-2311` | G1/Editor | Snapshot-indexed bounded workspace symbols | L | Done | Accepted `RFC-0045`; implementation `58a425fe42e5112071ddeda922e29cbf2f974148`; see `crates/ling-lsp/src/workspace_symbols.rs`, `crates/ling-lsp/tests/workspace_symbols.rs`, and `docs/status/IDE-2311-IMPLEMENTATION-REPORT.md` |
...
| `LSP-2401` | G1/Editor | Seed semantic-token taxonomy and negotiation decision | M | Done | Accepted `RFC-0046`; authority commit `cdc70731f75e27fc508402304e628dcc334c20fb`; consumed by completed LSP-2402/LSP-2403; see `docs/status/LSP-2401-IMPLEMENTATION-REPORT.md` |
| `LSP-2401-LEXICAL-SOURCE` | G1/Editor | Internal lexical token source index | S | Done | Accepted `DEC-0084`; consumed by completed LSP-2401/LSP-2402; see `crates/ling-db/src/token_source_index.rs` and `docs/status/LSP-2401-LEXICAL-SOURCE-IMPLEMENTATION-REPORT.md` |
| `LSP-2402` | G1/Editor | Snapshot-bound typed semantic-token generation | L | Done | Accepted `RFC-0047`; implementation `899d00f56d444f43a5128da844e517ef3a85e186`; consumed by completed LSP-2403; see `crates/ling-db/src/semantic_token_index.rs`, `crates/ling-db/tests/semantic_tokens.rs`, and `docs/status/LSP-2402-IMPLEMENTATION-REPORT.md` |
| `LSP-2402-CHECKED-IDENTITY` | G1/Editor | Internal checked-token identity observation | S | Done | Accepted `DEC-0085`; consumed by completed LSP-2402; see `crates/ling-db/src/checked_token_source_index.rs` and `docs/status/LSP-2402-CHECKED-IDENTITY-IMPLEMENTATION-REPORT.md` |
| `LSP-2403` | G1/Editor | Bounded semantic-token full and delta transport | L | Done | Accepted `RFC-0048`; implementation `75c2bd0b7d0dcd6e37cdb16e0ec854529f56f97f`; see `crates/ling-lsp/src/semantic_tokens.rs`, `crates/ling-lsp/tests/semantic_tokens.rs`, and `docs/status/LSP-2403-IMPLEMENTATION-REPORT.md` |
| `LSP-2403-SNAPSHOT-IDENTITY` | G1/Editor | Internal checked-token snapshot identity | S | Done | Accepted `DEC-0086`; consumed by completed LSP-2403; see `crates/ling-db/src/checked_token_source_index.rs` and `docs/status/LSP-2403-SNAPSHOT-IDENTITY-IMPLEMENTATION-REPORT.md` |
| `LSP-2404` | G1/Editor | Semantic token fixtures | M | Done | Accepted `RFC-0046`/`RFC-0047`/`RFC-0048`; implementation `9105ff5be4aad29b471d5997594156a923f5cb56`; see `tests/protocols/lsp-semantic-tokens/fixtures/v1.json` and `docs/status/LSP-2404-IMPLEMENTATION-REPORT.md` |
| `LSP-2404-CHECKED-SOURCE-FIXTURES` | G1/Editor | Internal checked-token source fixture corpus | S | Done | Accepted `DEC-0087`; consumed by completed LSP-2404; see `crates/ling-db/tests/checked_token_source.rs` and `docs/status/LSP-2404-CHECKED-SOURCE-FIXTURES-IMPLEMENTATION-REPORT.md` |
| `LSP-2501` | G1/Editor | Composed immutable request snapshot boundary | L | Done | Accepted DEC-0030 plus RFC-0023/RFC-0026/RFC-0029/RFC-0030/RFC-0032–RFC-0045/RFC-0048; integration evidence `e5434f632963d622834d90168980c9524414d12b`; see `tests/protocols/lsp-request-snapshot/README.md` and `docs/status/LSP-2501-IMPLEMENTATION-REPORT.md` |
| `LSP-2501-SNAPSHOT` | G1/Editor | Internal immutable request snapshot capture | S | Done | Accepted DEC-0030; consumed by completed LSP-2501; see `crates/ling-lsp/tests/request_snapshot.rs` and `docs/status/LSP-2501-SNAPSHOT-IMPLEMENTATION-REPORT.md` |
...
| `EFF-2105-MODEL-PROPERTIES` | G2 | Effect model deterministic property corpus | S | Done | Accepted `DEC-0067`; see `docs/status/EFF-2105-MODEL-PROPERTIES-IMPLEMENTATION-REPORT.md`; retained as the bounded model child of completed EFF-2105 |
| `EFF-2104` | G2 | 解释器与 VM Handler 执行 | L | Done | Accepted `DEC-0262`; complete checked interpreter and bytecode 1.4 Cell/State lowering, verifier, VM, differential, Fault, cancellation, resource, and compatibility evidence; implementation `1188b247`; see `docs/status/EFF-2104-IMPLEMENTATION-REPORT.md` |
| `EFF-2104-REJECTION-GATE` | G2 | Internal unresolved-handler execution rejection gate | S | Done | Accepted `DEC-0088`; historical no-unchecked-AST gate retained while checked runtime proceeds under `DEC-0261` |
| `EFF-2105` | G2 | Effect fuzz/property tests | L | Done | Accepted `DEC-0263`; deterministic checked-source generation, shrinking, residual-row comparison, and interpreter/VM property evidence completed in `3517ffcc`; see `docs/status/EFF-2105-IMPLEMENTATION-REPORT.md` |
| `TASK-2201` | G2 | Task 语法与 Checked Core | M | Done | Accepted `DEC-0264`; checked-only frontend/Core completed in `54e4cecb`; see `docs/status/TASK-2201-IMPLEMENTATION-REPORT.md`; runtime remains TASK-2203 through TASK-2206 |
...
| `TASK-2202` | G2 | Task 状态机 Lowering | L | Done | Accepted `DEC-0265`; checked-only `ling.task-machine/0.1` lowering completed in `450ec1ba`; execution remains TASK-2203 and later; see `docs/status/TASK-2202-IMPLEMENTATION-REPORT.md` |
...
| `TASK-2203` | G2 | 结构化生命周期 Runtime | L | Done | Accepted `DEC-0266`; scheduler-neutral checked lifecycle runtime completed in `e8765790`; see `docs/status/TASK-2203-IMPLEMENTATION-REPORT.md`; scheduling remains TASK-2204 and later |
...
| `TASK-2204` | G2 | 确定性测试调度器 | L | Done | Accepted `DEC-0267`; deterministic checked-runtime test scheduling, logical deadlines, typed traces, strict replay, and bounded BFS exploration completed in `e550f4fd`; see `docs/status/TASK-2204-IMPLEMENTATION-REPORT.md` |
...
| `TASK-2205` | G2 | 生产本地调度器 | L | Done | Accepted `DEC-0268`; checked `task main` file/project interpreter entry, fixed local worker pool, bounded queue/wake/park, cancellation/shutdown, internal Task-tree snapshots, and nonsemantic metrics completed in `330e1b2c`; see `docs/status/TASK-2205-IMPLEMENTATION-REPORT.md` |
| `TASK-2206` | G2 | Task conformance 与压力测试 | L | Done | Accepted `DEC-0269`; exact one-million Task-count ceiling and checked frontend/runtime/deterministic/production conformance plus bounded generated stress completed in `d0c542d3`; see `docs/status/TASK-2206-IMPLEMENTATION-REPORT.md` |
| `ACT-2301` | G2 | Actor 身份与状态隔离 | M | Done | Accepted `DEC-0270`; checked-only Core complete through `abb31810ffa8a96e637b83f14659cff1662e0527`; `docs/status/ACT-2301-IMPLEMENTATION-REPORT.md` |
...
| `ACT-2302` | G2 | 消息可发送性检查 | L | Done | Accepted `DEC-0271`; checked-only SendableLocal、canonical local message schema 与 Experimental `x-ling-actor/0.1` complete through `4e925c7ab8bc91f5724a5700d7abd7c3f6623955`; `docs/status/ACT-2302-IMPLEMENTATION-REPORT.md` |
...
| `ACT-2303` | G2 | 有界 Mailbox 与背压 | L | Done | Accepted `DEC-0272`; checked-only bounded local mailbox、`Reject` admission 与 Experimental `x-ling-actor/0.2` complete through `c0c5f8b24a6bdddc29c48973df75ef6fb6675195`; `docs/status/ACT-2303-IMPLEMENTATION-REPORT.md` |
...
| `ACT-2304` | G2 | Turn 与重入规则 | L | Done | Accepted `DEC-0273`; checked-only one-message、non-suspending、no-reentry、publish-on-return contract 与 Experimental `x-ling-actor/0.3` complete through `79081e2754954d2427d4bee5972a1d851178402a`; `docs/status/ACT-2304-IMPLEMENTATION-REPORT.md` |
...
| `ACT-2305` | G2 | Actor Runtime | L | Done | Accepted `DEC-0274`; see `crates/ling-eval/src/actor_runtime.rs`, `crates/ling-eval/tests/actor_runtime.rs`, and `docs/status/ACT-2305-IMPLEMENTATION-REPORT.md`; public execution remains `L-ACTOR-0002` |
...
| `ACT-2306` | G2 | Actor 性质与压力测试 | L | Done | Accepted `DEC-0275`; `crates/ling-eval/src/actor_runtime_properties.rs` supplies bounded cfg(test)-only serial/parallel/property/stress evidence through `3885ca9d74dcb6a05afe1c3fccc9abe578e843db`; public Actor execution remains `L-ACTOR-0002`; see `docs/status/ACT-2306-IMPLEMENTATION-REPORT.md` |
...
| `SUP-2401` | G2 | Supervisor 模型 | L | Done | Accepted `DEC-0276`; crate-private checked-Core `ContainOne` runtime and bounded evidence are implemented in `crates/ling-eval/src/actor_supervisor.rs` through `10f8e0c1d09177c97adbfcef283b2ed6c314649d`; public supervision remains blocked; see `docs/status/SUP-2401-IMPLEMENTATION-REPORT.md` |
...
| `SUP-2402` | G2 | 重启预算与熔断 | L | Done | Accepted `DEC-0277`; crate-private checked-Core `RestartOneBudgeted` logical-clock, per-slot sliding budget, fixed-backoff, and Closed/Open/HalfOpen recovery are implemented through `be9b8dd842815cff100267a645b9bef88b13c369`; public Actor execution remains `L-ACTOR-0002`; see `docs/status/SUP-2402-IMPLEMENTATION-REPORT.md` |
...
| `SUP-2403` | G2 | 监督测试 | L | Done | Accepted `DEC-0278`; exact private checked-runtime evidence matrix implemented through `d175501b007cf59928c47f9221f5a451d4fd1963`; public Actor execution remains `L-ACTOR-0002`; broader restore/escalation/Replay/backend claims remain deferred; see `docs/status/SUP-2403-IMPLEMENTATION-REPORT.md` |
...
| `REP-2501` | G2 | Determinism Class | L | Done | Accepted `DEC-0279`; exact private five-category executable matrix implemented in `45ea3c9749aea87da96b03857d34d5de908593cd`; public class metadata, Effect Log, and Replay remain blocked; see `docs/status/REP-2501-IMPLEMENTATION-REPORT.md` |
...
| `REP-2502` | G2 | Replay Log Schema | L | Done | Accepted `DEC-0280`; private non-serialized five-case structure evidence implemented in `ca1fcce6f435fb8419acc97fe813f3a773d5df8b`; public Effect Log and Replay schema remain blocked; see `docs/status/REP-2502-IMPLEMENTATION-REPORT.md` |
...
| `REP-2503` | G2 | Effect Recorder | L | Done | Accepted `DEC-0281`; private five-case checked Effect-boundary evidence implemented in `8a0f05b9a38f922c73339d4111e6927ac9cb693b`; public recorder/Effect Log scope remains blocked; see `docs/status/REP-2503-IMPLEMENTATION-REPORT.md` |
...
| `REP-2504` | G2 | Replay Player | L | Done | Private five-case checked Task replay baseline completed under Accepted `DEC-0282` in `c3e05bac815e55ace2bef58779094869f342b237`; public checkpoint/player scope remains blocked; see `docs/status/REP-2504-IMPLEMENTATION-REPORT.md` |
...
| `REP-2505` | G2 | 隐私、裁剪与损坏 | L | Done | Private five-case raw-retention/truncation/corruption/hermetic evidence baseline completed under Accepted `DEC-0283` in `b31bd278df5f3482052c463186063b03e13329c9`; public privacy/redaction/trimming/checksum/offline-tool scope remains blocked; see `docs/status/REP-2505-IMPLEMENTATION-REPORT.md` |
...
| `REP-2506` | G2 | 跨进程重放验收 | L | Done | Private five-case same-binary cross-process Task trace reconstruction baseline completed under Accepted `DEC-0284` in `e5f16355e02abb76680f6984427207ad96ae7b0a`; public Replay playback, Program/Schema mutation refusal, provenance, cache/toolchain, cross-backend/platform, and Stable scope remain blocked; see `docs/status/REP-2506-IMPLEMENTATION-REPORT.md` |
...
| `REM-2601` | G2 | RemoteRef 与 Endpoint | L | Done | Private five-case local-runtime scope and remote-coordinate separation baseline completed under Accepted `DEC-0285` in `ec5b2182676a1f2b8311b7a0e416dec42efe5705`; public RemoteRef identity/lifecycle, endpoint authority, authentication, Effects, delivery/Fault, serialization, transport, migration, cross-process, and Stable scope remain blocked; see `docs/status/REM-2601-IMPLEMENTATION-REPORT.md` |
