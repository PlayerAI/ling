...
| `EFF-2103-CORE` | G2 | First-order handler Typed Core projection | S | In Progress | Accepted `DEC-0063`; see `docs/status/EFF-2103-CORE-IMPLEMENTATION-REPORT.md`; parent remains BlockedSpec for source syntax/lowering |
