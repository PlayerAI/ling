...
| `EFF-2104` | G2 | 解释器与 VM Handler 执行 | L | In Progress | Accepted `DEC-0261`; interpreter complete and immutable/irrefutable `ling.bytecode/1.3` VM slice active; `GAP-EFFECT-HANDLER-BYTECODE-001` blocks shared Cell/refutable-pattern completion; see `docs/status/EFF-2104-AUTHORITY-AUDIT.md` |
