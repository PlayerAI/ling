...
| `TRAIT-1307` | G1/Editor | Interpreter/VM lowering | L | In Progress | Accepted RFC-0021; see `docs/status/TRAIT-1307-AUTHORITY-AUDIT.md`, `docs/status/TRAIT-1307-IMPLEMENTATION-REPORT.md`, and `03-G1-V0.1-LIVING.md:304` |
