...
| `TASK-2202` | G2 | Task 状态机 Lowering | L | Ready | Accepted `DEC-0265` authorizes checked-only `ling.task-machine/0.1` lowering; execution remains TASK-2203 and later; see `docs/status/TASK-2202-AUTHORITY-AUDIT.md` |
