...
| `RC-6904-SEED` | G6 | Seed RC2/final change-control inventory drift gate | S | In Progress | Accepted DEC-0055; see `cargo xtask rc2 verify`, `docs/testing/RC2-FINAL-CHANGE-CONTROL.md`, and `docs/status/RC-6904-SEED-IMPLEMENTATION-REPORT.md`; parent remains BlockedSpec |
