...
| `ACT-2304` | G2 | Turn 与重入规则 | L | Ready | Accepted `DEC-0273` checked-only one-message, non-suspending, no-reentry, publish-on-return profile; `docs/status/ACT-2304-AUTHORITY-AUDIT.md` |
