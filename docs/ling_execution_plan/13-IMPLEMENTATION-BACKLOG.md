...
| `SUP-2401` | G2 | Supervisor 模型 | L | Ready | Accepted `DEC-0276` authorizes the internal fixed-child `ContainOne` profile; implementation and evidence remain pending, while public supervision stays separately blocked |
