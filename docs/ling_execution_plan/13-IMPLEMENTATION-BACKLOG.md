...
| `EFF-2104` | G2 | 解释器与 VM Handler 执行 | L | In Progress | Accepted `DEC-0262`; checked input gate, interpreter, historical 1.3 slice, isolated 1.4 Cell/State codec/verifier, and private VM Cell primitive are complete; shared mutable Handler lowering and full differential evidence remain; see `docs/status/EFF-2104-AUTHORITY-AUDIT.md` |
