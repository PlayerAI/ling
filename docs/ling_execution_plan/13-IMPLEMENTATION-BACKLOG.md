...
| `RC-6901-SEED` | G6 | Seed RC0 internal-freeze inventory drift gate | S | In Progress | Accepted DEC-0052; see `cargo xtask rc0 verify`, `docs/testing/RC0-INTERNAL-FREEZE.md`, and `docs/status/RC-6901-SEED-IMPLEMENTATION-REPORT.md`; parent remains BlockedSpec |
