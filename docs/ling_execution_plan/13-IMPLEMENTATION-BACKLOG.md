...
G1：`TS-3101`、`TS-3102`、`TS-3103`、`TS-3104`、`TS-3105` Done；`TS-3106` In Progress，其余任务仍服从各自接口与 RFC 前置
...
| `TS-3106` | G1/Editor | Pattern 与 Type | M | In Progress | `05-ZED-EXTENSION.md:217`；共享 compiler/Tree-sitter corpus、编译器边界修正与 conformance evidence 正在集成；依赖 `TS-3105` Done |
