...
| `TASK-2203` | G2 | 结构化生命周期 Runtime | L | Ready | Accepted `DEC-0266` authorizes the scheduler-neutral lifecycle kernel and same-scope linear handle registry; see `docs/status/TASK-2203-AUTHORITY-AUDIT.md` |
