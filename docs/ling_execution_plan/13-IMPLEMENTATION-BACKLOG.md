...
| `EFF-2104` | G2 | 解释器与 VM Handler 执行 | L | In Progress | Accepted `DEC-0261`; checked interpreter and `ling.bytecode/1.3` implementation active; see `docs/status/EFF-2104-AUTHORITY-AUDIT.md` |
