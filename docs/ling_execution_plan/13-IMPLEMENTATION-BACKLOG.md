...
| `TASK-2201` | G2 | Task 语法与 Checked Core | M | Ready | Accepted `DEC-0264`; checked-only frontend/Core is authorized while runtime remains TASK-2202 through TASK-2206; see `docs/status/TASK-2201-AUTHORITY-AUDIT.md` |
