...
| `EFF-2105` | G2 | Effect fuzz/property tests | — | BlockedSpec | EFF-2104 runtime authority is complete; Proposed `DEC-0263` defines the remaining checked-source generator, deterministic shrinking, and differential-oracle gate; see `docs/status/EFF-2105-AUTHORITY-AUDIT.md` |
| `TASK-2201` | G2 | Task 语法与 Checked Core | M | BlockedSpec | EFF-2103 is complete; Proposed `DEC-0264` defines the remaining checked-only frontend/Core gate; runtime remains TASK-2202 through TASK-2206; see `docs/status/TASK-2201-AUTHORITY-AUDIT.md` |
