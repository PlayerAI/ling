...
| `LSP-2401` | G1/Editor | Seed semantic-token taxonomy and negotiation decision | M | Done | Accepted `RFC-0046`; authority commit `cdc70731f75e27fc508402304e628dcc334c20fb`; see `docs/status/LSP-2401-IMPLEMENTATION-REPORT.md`; typed generation and transport remain LSP-2402/LSP-2403 |
...
| `LSP-2402` | G1/Editor | Snapshot-bound typed semantic-token generation | L | Done | Accepted `RFC-0047`; implementation `899d00f56d444f43a5128da844e517ef3a85e186`; see `crates/ling-db/src/semantic_token_index.rs`, `crates/ling-db/tests/semantic_tokens.rs`, and `docs/status/LSP-2402-IMPLEMENTATION-REPORT.md`; LSP transport remains LSP-2403 |
