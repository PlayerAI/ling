...
G1：`TS-3101`、`TS-3102`、`TS-3103`、`TS-3104`、`TS-3105`、`TS-3106`、`TS-3107` Done；下一项 `TS-3108` Ready，其余任务仍服从各自接口与 RFC 前置
...
| `TS-3108` | G1/Editor | Grammar differential | M | Ready | `05-ZED-EXTENSION.md:234`；依赖 `TS-3107` Done；复用 compiler conformance corpus，不改变 compiler 合法性 |
