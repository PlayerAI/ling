...
| `TASK-2205` | G2 | 生产本地调度器 | L | BlockedSpec | Proposed `DEC-0268` defines the checked `task main` interpreter entry, fixed local worker pool, bounded queue/wake/park, cancellation/shutdown, internal Task-tree snapshots, and nonsemantic metrics; implementation waits for Accepted authority; see `docs/status/TASK-2205-AUTHORITY-AUDIT.md` |
