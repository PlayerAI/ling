...
| `PRJ-1107` | G1/Editor | Project API 与 CLI 接入 | M | BlockedSpec | `GAP-PROJECT-CLI-INTERFACE-001`; see `docs/status/PRJ-1107-AUTHORITY-AUDIT.md` |
...
| `LSP-2102-SOURCE-MAP` | G1/Editor | SourceMap position projection | S | In Progress | `DEC-0029`; see `crates/ling-source/src/position.rs` and `docs/status/LSP-2102-SOURCE-MAP-IMPLEMENTATION-REPORT.md`; parent LSP lifecycle remains BlockedSpec |
