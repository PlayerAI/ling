...
| `TASK-2205` | G2 | 生产本地调度器 | L | Ready | Accepted `DEC-0268` authorizes the checked `task main` interpreter entry, fixed local worker pool, bounded queue/wake/park, cancellation/shutdown, internal Task-tree snapshots, and nonsemantic metrics; see `docs/status/TASK-2205-AUTHORITY-AUDIT.md` |
