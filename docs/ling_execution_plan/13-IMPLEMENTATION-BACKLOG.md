...
| `TASK-2204` | G2 | 确定性测试调度器 | L | Ready | Accepted `DEC-0267` authorizes exact seed, virtual-time, trace/replay, and bounded-exploration behavior; see `docs/status/TASK-2204-AUTHORITY-AUDIT.md` |
