...
| `RC-6903-SEED` | G6 | Seed RC3 independent-verification inventory drift gate | S | In Progress | Accepted DEC-0054; see `cargo xtask rc3 verify`, `docs/testing/RC3-INDEPENDENT-VERIFICATION.md`, and `docs/status/RC-6903-SEED-IMPLEMENTATION-REPORT.md`; parent remains BlockedSpec |
