...
| `SUP-2402` | G2 | 重启预算与熔断 | L | Ready | Accepted `DEC-0277` authorizes the private logical-tick, per-slot restart-budget, fixed-backoff, and Closed/Open/HalfOpen circuit slice; implementation and executable evidence remain pending |
