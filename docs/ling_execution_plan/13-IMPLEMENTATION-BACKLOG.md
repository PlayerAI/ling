...
| `REP-2501` | G2 | Determinism Class | L | BlockedSpec | SUP-2403 is Done; Proposed `DEC-0279` defines a private five-category executable baseline but is not implementation authority until Accepted; public class metadata and Replay remain blocked; see `docs/status/REP-2501-AUTHORITY-AUDIT.md` |
