...
| `ACT-2303` | Bounded mailbox and backpressure | `G2` | `L` | `Done` | `ACT-2302` | `c0c5f8b24a6bdddc29c48973df75ef6fb6675195` |
...
| `ACT-2306` | Actor properties and stress tests | `G2` | `L` | `Done` | `ACT-2305` | `3885ca9d74dcb6a05afe1c3fccc9abe578e843db` |
...
| `REM-2601` | RemoteRef and endpoint | `G2` | `L` | `Done` | `ACT-2305`, `REP-2506` | `ec5b2182676a1f2b8311b7a0e416dec42efe5705` |
...
| `REP-2505` | Replay privacy, trimming, and corruption | `G2` | `L` | `Done` | `REP-2501`, `REP-2502`, `REP-2503`, `REP-2504` | `b31bd278df5f3482052c463186063b03e13329c9` |
...
| `REP-2506` | Cross-process replay acceptance | `G2` | `L` | `Done` | `REP-2501`, `REP-2502`, `REP-2503`, `REP-2504`, `REP-2505` | `e5f16355e02abb76680f6984427207ad96ae7b0a` |
