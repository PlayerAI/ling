...
its checked Handler Core are now complete. Accepted `DEC-0264` defines the
checked-only, non-executable Task frontend boundary; runtime lifecycle, Fault
aggregation, scheduling, and detach remain later decisions.
...
Runtime join/cancel/cleanup, Fault aggregation, scheduling,
...
Accepted DEC-0264, RFC-0001, RFC-0020,
