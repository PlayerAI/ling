...
The executable fixtures for `ling.lsp.pull-diagnostics/0.2` live in
...
reuses those exact adapted JSON values through the shared RFC-0034 root-control
projection. RFC-0033 remains the request/report authority and RFC-0034 owns the
0.2 controlled-set migration; this directory is not another schema.
