...
mod tests {
    ...
    fn repository_passes_the_aggregate_governance_gate() {
        ...
        assert_eq!(summary.document_count, 303);
        assert_eq!(summary.gap_count, 28);
        assert_eq!(summary.lifecycle_count, 278);
        assert_eq!(summary.protocol_count, 31);
        assert_eq!(summary.diagnostic_code_count, 94);
    }
}
