...
mod tests {
    ...
    fn repository_schema_corpus_is_valid_and_current() {
        ...
        assert_eq!(summary.schema_count, 6);
        assert_eq!(summary.valid_fixture_count, 8);
        assert_eq!(summary.invalid_fixture_count, 20);
    ...
    fn repository_has_no_false_n_minus_one_claim() {
        ...
        assert_eq!(summary.no_previous_version_count, 6);
    }
