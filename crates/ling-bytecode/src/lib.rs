...
//! implementation-active 1.3 Handler slice.
...
pub use disassemble::{disassemble_v1, disassemble_v1_1, disassemble_v1_2, disassemble_v1_3};
pub use encode::{
    EncodingError, EncodingErrorKind, encode_v1, encode_v1_1, encode_v1_1_with_limit, encode_v1_2,
    encode_v1_2_with_limit, encode_v1_3, encode_v1_3_with_limit, encode_v1_with_limit,
    encode_verified_v1, encode_verified_v1_with_limit,
};
...
pub use format::{
    ...
    BYTECODE_PROTOCOL_1_2, BYTECODE_PROTOCOL_1_3, DecodeLimits, FORMAT_VERSION, FORMAT_VERSION_1_0,
    FORMAT_VERSION_1_1, FORMAT_VERSION_1_2, FORMAT_VERSION_1_3, FormatVersion, HEADER_BYTES,
    LANGUAGE_VERSION, NO_INDEX, UNICODE_VERSION, UnicodeVersion,
};
pub use lower::{
    LoweredProgramV1, LoweredProgramV1_1, LoweredProgramV1_2, LoweredProgramV1_3, LoweringError,
    LoweringErrorKind, LoweringSource, lower_v1, lower_v1_1, lower_v1_2, lower_v1_3,
};
pub use model::{
...
pub use verify::{
    ...
    decode_and_verify_v1_3, decode_and_verify_v1_3_with_limit, decode_and_verify_v1_with_limit,
    verify_v1,
};
