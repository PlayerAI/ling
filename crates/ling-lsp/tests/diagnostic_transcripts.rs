...
use ling_lsp::{
    COMPLETION_PROTOCOL_VERSION, DIAGNOSTIC_CONTROL_PROTOCOL_VERSION, DIAGNOSTIC_PROTOCOL_VERSION,
    ...
    REFERENCES_PROTOCOL_VERSION, RENAME_PROTOCOL_VERSION, REQUEST_CANCELLATION_PROTOCOL_VERSION,
    RESOURCE_LIMITS_PROTOCOL_VERSION, SCHEDULING_PROTOCOL_VERSION,
    WORKSPACE_SYMBOL_PROTOCOL_VERSION, run_stdio,
};
...
fn load_manifest() -> Vec<FixtureCase> {
    ...
    let active_protocols = BTreeSet::from([
        ...
        WORKSPACE_SYMBOL_PROTOCOL_VERSION,
